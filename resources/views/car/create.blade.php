...
<div class="container mt-5">
    ...
    <div class="row align-items-center">
        <div class="col-md-12 mt">
            <div class="card">
                <!-- Form Create -->
                <form action="{{ route('car.store') }}" method="POST" enctype="multipart/form-data" class="container p-4 border rounded bg-white shadow text-black">
                    @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="merek_id" id="merek_id" class="form-select">
                                ...
                                @foreach ($data_merek as $brand)
                                    <option value="{{ $brand->id }}" {{ old('merek_id') == $brand->id ? 'selected' : '' }}>{{ $brand->name }}</option>
                                @endforeach
                            </select>
                        </div>

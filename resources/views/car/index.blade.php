                                    ...
                                    <table class="table table-light">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('car.show', $car->id) }}"><img src="Frame 48.svg" alt="Show"></a>
                                                    <a href="{{ route('car.edit', $car->id) }}"><img src="Frame 47.svg" alt="Edit"></a>
                                                    <form id="delete-form-{{ $car->id }}" action="{{ route('car.destroy', $car->id) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a href="#" onclick="if(confirm('Apakah Anda yakin ingin menghapus data ini?')) { document.getElementById('delete-form-{{ $car->id }}').submit(); }">

...
<body class="bg-gray-100 flex items-center justify-center w-screen h-screen">
    ...
    <div class="bg-white rounded-lg shadow-lg w-full h-full flex overflow-hidden">
        ...
        <div class="hidden lg:flex flex-1 flex-col justify-center items-center bg-blue-100 p-8">
            <h3 class="text-3xl font-bold text-gray-700 mt-4">Selamat Datang Di <span
                    class="text-blue-600">HummaCar</span></h3>
        ...
        <div class="flex-1 p-8 lg:p-12">
            <div class="card">
                <div class="flex-1 p-8 lg:p-12">
                    ...
                    @endif
                    <h2 class="text-3xl font-bold text-gray-800 text-center " style="margin-top: 30px">Masuk</h2>
                        ...
                        <div class="mb-4 relative">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="togglePassword('password', this)"
                                    ...
                                    <svg class="h-5 w-5 text-gray-500 transition-transform duration-300 transform"
                                        ...
                                        <line class="icon-eye-closed" x1="2" x2="22" y1="2"
                                            y2="22"></line>
                                        <!-- Ikon mata terbuka -->
                                        <path class="icon-eye-open hidden"
                                            d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"></path>
                                        <circle class="icon-eye-open hidden" cx="12" cy="12" r="3">
                                        </circle>
                                    </svg>
                                </button>
                            </div>

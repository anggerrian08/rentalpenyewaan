...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.html"><img src="assets/images/logo/logo.svg" alt="Rental" srcset=""></a>
            </div>
    ...
    <div class="sidebar-menu">
        ...
        <li class="sidebar-item">
            <a href="{{ route('plat.index') }}" class='sidebar-link'>
        ...
        <li class="sidebar-item">
            <form action="{{ route('logout') }}" method="POST" style="display: inline;">
                @csrf
                <a href="#" class="sidebar-link" onclick="event.preventDefault(); this.closest('form').submit();" title="Logout">

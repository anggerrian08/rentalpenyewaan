...
@section('content')
    ...
    <head>
        ...
        <!-- Modal for each user -->
        @foreach ($data as $item)
            <div class="modal fade" id="show{{ $item->user->id }}" tabindex="-1"
                aria-labelledby="showModalLabel{{ $item->user->id }}" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="showModalLabel{{ $item->user->id }}">User Details:
                                {{ $item->user->email }}</h5>
                        ...
                        <div class="modal-body">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><strong>Phone Number:</strong> {{ $item->user->phone_number }}
                                </li>

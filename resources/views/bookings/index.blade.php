    ...
    <div class="container mt-5">
        ...
        <div class="kotak-biru">
            <div class="d-flex justify-content-between align-items-start mb-3">
                <div>
                    <h2 class="text-white fw-bold mb-1">Data Booking</h2>
                    <p class="text-white fw-bold mb-0" style="font-size: 0.9rem;">Menu | Data Booking</p>
                </div>
            </div>
        </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="col-md-2 p-0 text-end">
                    <form action="{{ route('merek.index') }}"
                        ...
                        <input type="text" style="border: none;" placeholder="Cari booking mobil..." aria-label="Search"
                            name="search">
                    </form>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{ asset('storage/uploads/ktp/' . $booking->user->ktp) }}"
                                                alt="KTP" class="img-thumbnail" style="width: 100px; height: auto;">
                                        </td>
                                        <td class="text-center">
                                            <img src="{{ asset('storage/uploads/sim/' . $booking->user->sim) }}"
                                                alt="SIM" class="img-thumbnail" style="width: 100px; height: auto;">
                                        </td>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="borrowedModalLabel{{ $booking->id }}">
                                                            Detail
                                                            Borrowed</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p><strong>Tanggal Kembali:</strong> {{ $booking->return_date }}
                                                        </p>
                                                        <p><strong>Status:</strong> {{ ucfirst($booking->status) }}</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <form
                                                            action="{{ route('bookings.proses_pengembalian', $booking->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <button type="submit" class="btn btn-primary">Ubah Status ke In
                                                                Process</button>
                                                        </form>

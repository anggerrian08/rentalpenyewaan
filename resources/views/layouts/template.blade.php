...
.logo-wrapper {
    border-bottom: 1px solid #ddd; /* Garis tipis */
    padding-bottom: 10px; /* Beri jarak bawah */
    margin-bottom: 10px; /* Jarak untuk elemen di bawahnya */
}

.sidebar-list a[href="{{ route('dashboard') }}"] {
    border-bottom: 1px solid #ddd; /* Garis tipis */
    padding-bottom: 10px; /* Beri jarak bawah */
    display: block; /* Pastikan elemen penuh */
}
.nav-right {
  display: flex;
...
.profile-nav {
  margin-left: auto; /* Ini memastikan elemen berada di ujung kanan */
}
            ...
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list"><i class=""></i><a class="sidebar-link" href="{{ route('dashboard') }}">
